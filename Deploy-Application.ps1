...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\vcredist_x86_2012.exe" -Parameters '/silent' -WindowStyle 'Hidden'
  ...
  # If ($useDefaultMsi) {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# This uninstall string may not work, this is because the MSI doesn't register the code properly, and even if you run it /x with the installer, it will say the software is not there. This is the correct product code though and I'm leaving it in because I have had it work sometimes. See Trello documentation.
