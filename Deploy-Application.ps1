...
Try {
  ...
  # If ($useDefaultMsi) {
	...
	#	}
		...
		Execute-Process -Path 'C:\Program Files (x86)\PST\E-Prime 3.0 Subject Station (3.0.3.31)\Program\LicenseManager.exe' -Parameters '/sr /user="Student" /institution="MSUDenver" /serial="LOLSERIALNUMBERHERE"' -WaitForMsiExec:$true
