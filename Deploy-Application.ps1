...
Try {
  ...
  # If ($useDefaultMsi) {
	...
	#	}
		...
		Execute-Process -Path 'C:\Program Files (x86)\PST\E-Prime 3.0 Subject Station (3.0.3.31)\Program\LicenseManager.exe' -Parameters '/sr /user="Student" /institution="MSUDenver" /serial="PUT SERIAL HERE"' -WaitForMsiExec:$true
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action Uninstall -Path '{8D597E83-DB7F-48CC-A762-43F9D4EEBCB1}'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD4QNlZvqMrfe7h
# zPeqAoWp2wTNldiJL543DtFh4mmhm6CCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgGzNC0wAw
# 9NY0CefwaDdGlun24t9GPglDjRhpE3Z5VrgwDQYJKoZIhvcNAQEBBQAEggEAh3Xc
# yks+evKulr7o+wYiQTvReqNhcL3b3KbOrJNE0nnwiKyQtgROx4f9V5jc9ExjZjr9
# fMJdwDtNlo8FYscgIbI5BMvbYcCqM8ChVjLBFpaBVotZlnK1Sq5d1Ul+gSRFKWVC
# SFuQlkeUphU6UG9nocMa6DVyfPdBeVSto4XvIbdnZ1loQpxSKv29PF778LjnmMM9
# bfH7y6uzYKW8EBfMI1hARyMXozqEo4SZk/rtcXP+mkrXWY2OXcpP4Edq5IH+XkLw
# zns05ueaiGycno9sJK7ceFZ2zZIPidyzVQGECphklZxrXLm4Gi6AV43E0FmDlv97
# SN07EH0ZtGuJWU3uKqGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA4MjMxNjIyNDhaMCMGCSqGSIb3DQEJBDEWBBQzeHtZ
# 88jg7fzkMQHL0U3C4832RjCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAV6oUURxssl+yHOBy7v5H2rc9Hp1Z9X8bsChNKjL7Guh9fF5uqeDq8JNYP0PG
# 0X8v68s3peLYfYs37B5/1USGv0KVmyrgGvLZXwhMEsO//79h8TN40TwB1wc/qQX2
# 34Af4esZTnqjBliTDcZZnhgsMvKwXtlTfuP4lm7gyg2f2+6ipJIbAHXhRp8jXd8S
# 7Yf4opVoQzuZZCOD9UtqOCRdZfHNqbbXmpSnJ91h8+aaVUzdLP51CQe9kSP5cE/P
# P5RRjlbTpuyKD+gNAZva7OsovRhb7mnrXf/ZddEhARZkgDI1t/01QKbP8wulNrcB
# FI/Te2bnvtlhc0xh0uLuosY04g==
